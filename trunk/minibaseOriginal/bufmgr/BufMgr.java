...
/**
 * A buffer hashtable entry description class. It describes  each entry for the buffer hash table, the page number and  frame number for that page, the pointer points to the next hash table entry.
 */
class BufHTEntry {
...
/**
 * A buffer hashtable to keep track of pages in the buffer pool.  It inserts, retrieves and removes pages from the h ash table.
 */
