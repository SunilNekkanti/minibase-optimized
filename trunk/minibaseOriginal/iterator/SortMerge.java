...
public class SortMerge extends Iterator implements GlobalConst
{
	...
	private  Heapfile temp_file_fd1;
	private  Heapfile temp_file_fd2;
	...
	{		
		...
		while (true)
		{
			if (process_next_block)
			{
				...
				if (get_from_in2 && (tuple2 = p_i2.get_next()) == null)
				{
					done = true;
					return null;
				}
				...
				int comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, tuple1,
				...
				if (io_buf1.Get(TempTuple1) == null)                // Should not occur
